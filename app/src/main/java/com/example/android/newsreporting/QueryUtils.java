...
public class QueryUtils {
    /**
     * Query the open Guardian dataset and return a list of {@link News} objects.
     */
...
// Create URL object
    ...
    public static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            JSONObject baseJsonObject = rootJsonResponse.getJSONObject("response");
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                JSONArray innerArray = jsonObject.getJSONArray("tags");
                String authorName;
                if (innerArray.length() >= 1) {
                    JSONObject innerObject = innerArray.getJSONObject(0);
                    authorName = innerObject.getString("webTitle");
                } else {
                    authorName = "Not Available";
                }

                News mNews = new News(authorName, sectionName, webTitle, url);
